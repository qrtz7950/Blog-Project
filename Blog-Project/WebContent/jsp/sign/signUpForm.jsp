		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-login">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="login-form" action="${pageContext.request.contextPath}/login/loginProcess.do" method="post" role="form" id="lform" style="display: block;">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
											<input type="submit" name="login-submit" id="confirmPw" tabindex="4" class="form-control btn btn-login" value="Log In">
											<input type="button" tabindex="5" class="form-control btn btn-login" onclick="location.href='${pageContext.request.contextPath}'" value="Back">
										</div>
									</div>
								</div>
								<div class="form-group">
...
<a href="${ pageContext.request.contextPath }/member/signUpProcess.do">제출</a>
</body>
</html>